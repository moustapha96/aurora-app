...
export const InfluentialEditor = ({ people, onUpdate }: InfluentialEditorProps) => {
  ...
  // Handle image upload using centralized utility - ensures correct RLS path: {userId}/influential/{timestamp}.{ext}
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Upload using centralized utility - path: {userId}/influential/{timestamp}.{ext}
      const result = await uploadFamilyImage(file, user.id, 'influential');
