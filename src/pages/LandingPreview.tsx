        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Personnalisez votre page de profil public
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="show-wealth" className="flex flex-col">
                  <span>Badge de richesse</span>
                  <span className="text-sm text-muted-foreground font-normal">
                    Afficher votre cercle de richesse (Diamond, Platinum, Gold)
                  </span>
                </Label>
                <Switch
                  id="show-wealth"
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="show-location" className="flex flex-col">
                  ...
                  <span className="text-sm text-muted-foreground font-normal">
                    Afficher votre pays sur la page
                  </span>
                </Label>
                <Switch
                  id="show-location"
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="show-quote" className="flex flex-col">
                  ...
                  <span className="text-sm text-muted-foreground font-normal">
                    Afficher votre citation sur la page
                  </span>
                </Label>
                <Switch
                  id="show-quote"
          ...
          <Card className="p-6 mb-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="custom-headline">Titre personnalisé</Label>
                <Input
                  id="custom-headline"
                  placeholder="Remplacera votre nom si renseigné"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Remplacera votre fonction si renseignée"
          ...
          <div className="p-6 bg-muted/30 rounded-lg border border-border">
            <h3 className="text-lg font-medium text-foreground mb-2">
              Comment utiliser votre landing page ?
            </h3>
            <ul className="text-sm text-muted-foreground space-y-2">
              <li>• Sélectionnez un template et configurez les options d'affichage</li>
              <li>• Cliquez sur "Enregistrer" pour sauvegarder vos préférences</li>
              <li>• Utilisez "Aperçu" pour voir le résultat final</li>
              <li>• Copiez le lien pour partager votre profil public</li>
              <li>• Le lien peut être partagé avec des contacts externes à Aurora Society</li>
            </ul>
          </div>
        </div>
      </main>
