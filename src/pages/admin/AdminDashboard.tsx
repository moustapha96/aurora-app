        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('adminLast5Members')}</CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('adminQuickActionsDescription')}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <p className="font-medium text-foreground">{t('adminManageMembers')}</p>
                  <p className="text-xs text-muted-foreground">{t('adminViewAllMembers')}</p>
                </button>
                ...
                >
                  ...
                  <p className="font-medium text-foreground">{t('adminManageRoles')}</p>
                  <p className="text-xs text-muted-foreground">{t('adminAssignRoles')}</p>
                </button>
                ...
                >
                  ...
                  <p className="font-medium text-foreground">{t('adminModeration')}</p>
                  <p className="text-xs text-muted-foreground">{t('adminContentToReview')}</p>
                </button>
                ...
                >
                  ...
                  <p className="font-medium text-foreground">{t('adminAnalytics')}</p>
                  <p className="text-xs text-muted-foreground">{t('adminDetailedStats')}</p>
                </button>
              </div>
            </CardContent>
          </Card>
