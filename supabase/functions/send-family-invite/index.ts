...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailResponse = await resend.emails.send({
      from: "Aurora Circle <onboarding@resend.dev>",
      to: [recipientEmail],
      subject: `${senderName} vous invite à rejoindre Aurora Circle`,
      html: `
        <!DOCTYPE html>
        <html>
        <head>
                ...
                <table width="100%" style="max-width: 600px; background: linear-gradient(145deg, #1a1a1a, #0d0d0d); border: 1px solid rgba(212, 175, 55, 0.2); border-radius: 16px; overflow: hidden;">
                  ...
                  <tr>
                    <td style="padding: 40px 40px 20px; text-align: center; border-bottom: 1px solid rgba(212, 175, 55, 0.1);">
                      ...
                      <p style="margin: 8px 0 0; color: rgba(212, 175, 55, 0.6); font-size: 12px; letter-spacing: 2px;">CIRCLE</p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <p style="margin: 0 0 20px; color: rgba(255, 255, 255, 0.8); font-size: 16px; line-height: 1.6;">
                        <strong style="color: #d4af37;">${senderName}</strong> vous invite à rejoindre Aurora Circle en tant que membre de son entourage proche.
                      </p>
                  ...
                  <tr>
                    <td style="padding: 24px 40px; border-top: 1px solid rgba(212, 175, 55, 0.1); text-align: center;">
                      <p style="margin: 0; color: rgba(255, 255, 255, 0.4); font-size: 12px;">
                        © ${new Date().getFullYear()} Aurora Circle. Tous droits réservés.
                      </p>
                    </td>
                  </tr>
                </table>
