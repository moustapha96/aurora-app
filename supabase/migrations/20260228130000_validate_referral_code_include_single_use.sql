-- Étendre validate_referral_code pour accepter aussi les codes à usage unique (single_use_invitation_codes).
-- Ainsi la page d'inscription (anon) n'a besoin que de cette seule RPC déjà autorisée.
...
BEGIN
  ...
  -- 2) Code à usage unique (single_use_invitation_codes, créés sur la page Parrainage)
