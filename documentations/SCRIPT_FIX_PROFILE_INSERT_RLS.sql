-- Script pour corriger l'erreur RLS lors de la création de profil
-- À exécuter dans le SQL Editor du Supabase Dashboard
-- Ce script corrige l'erreur "new row violates row-level security policy for table profiles"
