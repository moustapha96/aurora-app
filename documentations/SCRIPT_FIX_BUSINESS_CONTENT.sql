...
-- Policy 1 : Users can view their own business content
...
-- Policy 2 : Users can view friends business content (if they have business_access)
...
-- Policy 3 : Users can insert their own business content
...
-- Policy 4 : Users can update their own business content
...
-- Policy 5 : Users can delete their own business content
...
-- ============================================
-- 4. VÉRIFIER/CRÉER LE BUCKET personal-content
-- ============================================
...
-- ============================================
-- 5. CRÉER LES STORAGE POLICIES POUR personal-content
-- ============================================

-- Policy 1 : Users can view their own files (including subdirectories like business/)
...
-- Policy 2 : Users can upload their own files (including subdirectories like business/)
...
-- Policy 3 : Users can update their own files (including subdirectories like business/)
...
-- Policy 4 : Users can delete their own files (including subdirectories like business/)
